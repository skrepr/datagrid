 ...
 *
 * TODO this is copy/paste stuff. This needs to be replaced with something better. Or not.
 */
class Request
{
    ...
    public function setQuery($spec, $value = null)
    {
        if ((null === $value) && !is_array($spec)) {
            die('Invalid value passed to setQuery(); must be either array of values or key/value pair');
        }
        if ((null === $value) && is_array($spec)) {
